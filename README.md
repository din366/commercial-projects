...
:zap: [minsk-work.by - Страница для контекстной рекламы для поиска новых сотрудников с формой захвата (Webpack, Vanilla JS, SCSS, PHP)](#minskwork)   
...
---
<a name="minskwork"></a>
## :star: minsk-work.by - Страница для контекстной рекламы для поиска новых сотрудников с формой захвата

:o: <a href="https://minsk-work.by">[Ссылка на проект]</a>

<img align="center" max-width="600px" src="https://raw.githubusercontent.com/din366/images/main/readme%20images/commercial-projects/minsk-work-main-page.png" alt="photo">
...
2. Ключевой целью одностраничника - сбор заявок для дальнейшего рассмотрения. Поэтому на странице была подготовлена форма захвата. Для большей вовлеченности 
и конверсии форма захвата состоит из нескольких этапов. Тем самым минимизируется возможность отпугнуть потенциального работника количеством вопросов.
